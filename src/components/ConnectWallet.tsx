              ...
              <div className='bg-white hover:shadow-xl rounded-full p-1 flex flex-row items-center gap-2 pr-4 cursor-pointer' onClick={handleLogout}>
                <span className='bg-red-100 border border-red-400 rounded-full p-1'>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7 4C4.58803 5.66502 3 8.50052 3 11.7185C3 16.8445 7.02944 21 12 21C16.9706 21 21 16.8445 21 11.7185C21 8.50052 19.412 5.66502 17 4" stroke="black" stroke-width="null" stroke-linecap="round" className="my-path"></path>
