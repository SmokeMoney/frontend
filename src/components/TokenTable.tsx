            ...
            >
              <label className="relative gap-1 inline-flex items-center rounded-full p-2  bg-[#171821]">
                ...
                <input
                  ...
                  type="text"
                  placeholder="0.0"
                  className="w-[50px] bg-transparent text-zinc-300 outline-none mr-2"
                />
              </label>
            </div>
          </div>
          ...
          <DropdownMenu.Portal>
            <DropdownMenu.Content className="">
              <div className="mt-2 overflow-auto h-80 bg-[#171821] rounded-xl text-zinc-400 border">
                <div className="border-b p-3 font-bold sticky top-0 bg-[#171821] z-50">
                  Switch Network
                </div>
